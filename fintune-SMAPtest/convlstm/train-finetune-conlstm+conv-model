...
def main(lr,total_epoch,ConvLSTM_kernel_size,batch_size,ConvLSTM_num_layers1,ConvLSTM_num_layers2):
    features_train = np.load('../../SMAPtest/convlstm-model/data-ConLSTM-model/features_train.npy')
    label_train = np.load('../../SMAPtest/convlstm-model/data-ConLSTM-model/label_train.npy')
    ...
    ConvLSTM_net.load_state_dict(torch.load('../../ERA5test/conlstm-model/data-ConLSTM-model/ConvLSTM_net_params.pth'))
    ConvLSTM_net.cuda()

    CNN_net.load_state_dict( torch.load('../../ERA5test/conlstm-model/data-ConLSTM-model/CNN_net_params.pth'))
    CNN_net.cuda()
...
if __name__ == '__main__':
    ...
    p.add_argument('--total_epoch', type=int, default=50, help='total epochs for training the model')
