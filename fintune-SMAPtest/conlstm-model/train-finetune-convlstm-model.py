...
def main(lr,total_epoch,batch_size,ConvLSTM_num_layers,ConvLSTM_kernel_size,seq_length):
    ...
    features_train=np.load('../../SMAPtest/conlstm-model/data-ConLSTM-model/features_train.npy')
    label_train =  np.load('../../SMAPtest/conlstm-model/data-ConLSTM-model/label_train.npy')
    ...
    net = torch.load('../../ERA5test/conlstm-model/data-ConLSTM-model/convlstm_params.pkl')
    net.cuda()
