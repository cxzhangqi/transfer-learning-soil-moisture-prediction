...
def main(model_name,ConvLSTM_kernel_size,ConvLSTM_num_layers):
    label_test=np.load('../../SMAPtest/conlstm-model/data-ConLSTM-model/label_test.npy')
    print('label_test',label_test.shape)
    features_test=np.load('../../SMAPtest/conlstm-model/data-ConLSTM-model/features_test.npy')
    scalar_set=np.load('../../SMAPtest/conlstm-model/data-ConLSTM-model/scalar_set.npy')
