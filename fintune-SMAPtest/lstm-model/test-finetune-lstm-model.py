...
def main(model_name):
    label_test=np.load('../../SMAPtest/lstm-model/data-lstm-model/label_test.npy')
    features_test=np.load('../../SMAPtest/lstm-model/data-lstm-model/features_test.npy')
    scalar_set=np.load('../../SMAPtest/lstm-model/data-lstm-model/scalar_set.npy')
    ...
    model = torch.load('./data-lstm-model/lstm_params.pkl')
    model = model.cuda()
