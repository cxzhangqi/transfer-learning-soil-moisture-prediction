...
def main(lr,total_epoch,batch_size):
    features_train = np.load('../../SMAPtest/lstm-model/data-lstm-model/features_train.npy')
    label_train = np.load('../../SMAPtest/lstm-model/data-lstm-model/label_train.npy')
    ...
    net = torch.load('../../ERA5test/lstm-model/data-lstm-model/lstm_params.pkl')
    ...
    torch.save(model, './data-lstm-model/lstm_params.pkl')
