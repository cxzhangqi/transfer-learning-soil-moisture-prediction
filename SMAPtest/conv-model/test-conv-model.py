...
def main(model_name):
    label_test=np.load('./data-con-model/label_test.npy')
    features_test=np.load('./data-con-model/features_test.npy')
    scalar_set=np.load('./data-con-model/scalar_set.npy')
