...
def main(datadir,seq_length,lead_time):
    ...
    if not os.path.exists(dir):
        os.mkdir(dir)
    np.save('./data-con-model/features_train.npy', features_train)
    np.save('./data-con-model/label_train.npy', label_train)
    np.save('./data-con-model/features_test.npy', features_test)
    np.save('./data-con-model/label_test.npy', label_test)
    np.save('./data-con-model/scalar_set.npy', scalar_set)
